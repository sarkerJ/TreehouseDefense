...
{
    class ResurrectingInvader : IInvader //this is a composition We ARe not Inheriting from IInvader as you can see from the 2 private invaders (adding different types together to make a new class)
    {
